...
void m05_00_muscle_model(Segment **segment_data[], Structure *calibrate_pos[], Muscle **muscle_data[], Muscle *muscle_model[], 
						 ...
						 int muscles, int ligaments, Muscle *patella_ratio_av[], XML_Parameters* _parameters)
{

	string muscle_full_name = _parameters->subject_anatomy_data_path + "\\" + _parameters->anatomy->muscle_geometry_file_name;
	//cout<<muscle_full_name;
	
	string ligament_full_name =  _parameters->subject_anatomy_data_path + "\\" + _parameters->anatomy->ligament_geometry_file_name;
	//cout<<ligament_full_name;

	m05_01_pick_muscle_model(muscle_model,calibrate_pos,muscles, muscle_full_name, _parameters);
	m05_01_pick_muscle_model(ligament_model,calibrate_pos,ligaments, ligament_full_name, _parameters);
	...
	m05_01_02_initialize_generic_quad(muscle_model,frames,muscles, patella_ratio_av);
